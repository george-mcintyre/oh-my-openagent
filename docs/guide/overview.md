...
```
Install and configure George McIntyre's fork of oh-my-openagent by following the instructions here:
...
```jsonc
{
  "$schema": "https://raw.githubusercontent.com/george-mcintyre/oh-my-openagent/dev/assets/oh-my-openagent.schema.json",
